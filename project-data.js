const projectData = [
  ...
  {
    title: "GhostHunter - Python App",
    miniDesc:
      "Ghost Hunter is a Python-based tool for detecting and analyzing potential vulnerabilities in web applications. The tool is designed to help security professionals identify security flaws and weaknesses that may be exploitable by attackers.",
    website: "https://github.com/bfrisbyh92/GhostHunter",
    github: "https://github.com/bfrisbyh92/GhostHunter.git",
    img: "/assets/images/projects/infogath.png",
    seoimg: "/assets/images/projects/infogath.png",
    link: "ghosthunter",
    showOnHome: true,
    tech: [
      "Web Vulnerability Scanner",
      "Open Source Intelligence",
      "Modify or Create Wordlists",
      "Python",
      "HTTP Requests",
      "BeautifulSoup",
      "Colorama",
    ...
    desc: "Ghost Hunter is a powerful tool for security professionals, designed to help identify and analyze potential vulnerabilities in web applications through OSINT and web application security techniques. The tool provides a range of features and functions that enable users to perform in-depth analyses of web applications, detect potential security flaws and weaknesses, and explore attack vectors that may be exploited by malicious actors.Currently, Ghost Hunter includes several features, such as host header injection testing, PDF analysis, IP tracing, image reconnaissance, clickjacking vulnerability detection, subdomain reconnaissance, and password list creation/modification. However, the project is still a work in progress, and more features are being developed regularly.",
  },
  {
    title: "Python-GTK Form Cracker",
    miniDesc: "Python GTK 3.0 GUI application that uses subprocesses and Hydra on the command line to automate password cracking. Can be ran on any service, and just needs a few inputs in the GUI. Right now output is in terminal, will switch to inside GTK and add style soon.",
    ...
    desc: "Python GTK 3.0 GUI application that uses subprocesses and Hydra on the command line to automate password cracking. Can be ran on any service, and just needs a few inputs in the GUI. Right now output is in terminal, will switch to inside GTK and add style soon.",
  },
  {
