...
export default function BlogSection() {
    ...
    return <div>
        <SubHeader
            title="My Blog"
            caption="I honestly enjoy writing, sharing information, and learning from others. Check out some of my blog posts. Drop a reccommendation for a topic to cover."
        />
